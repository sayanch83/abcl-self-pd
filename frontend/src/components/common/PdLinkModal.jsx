        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {[
                { step: '1', text: 'Customer taps the link in the SMS on their phone' },
                { step: '2', text: 'They enter their registered mobile number to receive an OTP via SMS' },
                { step: '3', text: 'After OTP verification, they complete the Self-PD form and upload photos' },
                { step: '4', text: 'Status here updates to Completed once the customer submits' },
              ].map(({ step, text }) => (
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1.5">
              Share this on WhatsApp if the customer did not receive the SMS.
            </p>
          </div>
        </div>
